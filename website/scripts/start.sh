            ...
            if [[ "$USE_DOCKER" == "yes" ]]; then
                ...
                if command -v gnome-terminal &> /dev/null; then
                    gnome-terminal \
                        ...
                        --tab --title="Frontend" -- bash -c "cd \"$SCRIPTS_ROOT/frontend\" && export ENVIRONMENT=dev && npm install && (npm audit fix || echo \"Audit fix failed, continuing...\") && npm run dev; exec bash" \
                    ...
                    konsole \
                        ...
                        --new-tab -p tabtitle="Frontend" -e bash -c "cd \"$SCRIPTS_ROOT/frontend\" && export ENVIRONMENT=dev && npm install && (npm audit fix || echo \"Audit fix failed, continuing...\") && npm run dev" \
                    ...
                    x-terminal-emulator -T "Frontend" -e bash -c "cd \"$SCRIPTS_ROOT/frontend\" && export ENVIRONMENT=dev && npm install && (npm audit fix || echo \"Audit fix failed, continuing...\") && npm run dev" &
                    ...
                    (cd website/frontend && export ENVIRONMENT=dev && npm install && (npm audit fix || echo "Audit fix failed, continuing...") && npm run dev &)
