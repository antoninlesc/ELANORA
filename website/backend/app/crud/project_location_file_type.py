...
async def add_file_type_to_location(db: AsyncSession, project_id: int, location_id: int, project_file_type_id: int):
...
async def remove_file_type_from_location(db: AsyncSession, project_id: int, location_id: int, project_file_type_id: int):
...
async def get_file_types_for_location(db: AsyncSession, project_id: int, location_id: int):
