...
class StandardComponent(Base):
    ...
    naming_standard_id: Mapped[int] = mapped_column(
        Integer, ForeignKey("PROJECT_NAMING_STANDARD.id", ondelete="CASCADE"), nullable=False
    )
    ...
    naming_standard = relationship("ProjectNamingStandard", back_populates="standard_components")
